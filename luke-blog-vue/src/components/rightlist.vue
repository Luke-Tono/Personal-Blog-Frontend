        ...
        <div class="catch-me">
          <div class="">
            ...
            <el-tooltip
              ...
              placement="top"
            >
              <a :href="catchMeObj.linkedIn" target="_blank"
          ...
          <div class="">
            ...
            <el-tooltip
              ...
              placement="top"
            >
              <a :href="catchMeObj.resume" target="_blank"><i class="fa fa-id-card"></i></a>
            </el-tooltip>
          </div>
        </div>
      </div>
...
export default {
  data() {
    ...
    return {
      ...
      catchMeObj: {
        //个人信息
        github: "https://github.com/Luke-Tono",
        qq: "static/img/qq.png",
        linkedIn: "https://www.linkedin.com/in/xihe-zhao-00ab38330/",
